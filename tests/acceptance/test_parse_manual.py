...
def parsed_text(parse_state: dict[str, Any], text: str) -> None:
    document: Document = parse_state["document"]
    assert document.text == text


@then(parsers.parse('it contains one place span "{text}"'))
def parsed_place(parse_state: dict[str, Any], text: str) -> None:
    document: Document = parse_state["document"]
...
def parsed_identifier(parse_state: dict[str, Any], identifier: str) -> None:
    document: Document = parse_state["document"]
