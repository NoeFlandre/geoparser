...
| --- | --- | ---: | ---: | ---: |
| upstream | cuda | 0.037 | 0.109 | 0.055 |
| hybrid | cuda | 0.090 | 0.698 | 0.160 |
| prior | cuda | 0.090 | 0.698 | 0.160 |

## Resolution (gold spans supplied, distance scored)

| Pipeline | Device | Acc@161km | Mean err (km) | Median err (km) | AUC | Seconds |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| upstream | cuda | 0.643 | 670.4 | 42.7 | 0.360 | 39.7 |
| hybrid | cuda | 0.643 | 670.4 | 42.7 | 0.360 | 59.7 |
| prior | cuda | 0.589 | 1234.4 | 51.7 | 0.393 | 46.3 |
