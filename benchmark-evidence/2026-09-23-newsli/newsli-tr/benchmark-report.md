...
| --- | --- | ---: | ---: | ---: |
| upstream | cuda | 0.112 | 0.131 | 0.121 |
| hybrid | cuda | 0.213 | 0.708 | 0.328 |
| prior | cuda | 0.213 | 0.708 | 0.328 |

## Resolution (gold spans supplied, distance scored)

| Pipeline | Device | Acc@161km | Mean err (km) | Median err (km) | AUC | Seconds |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| upstream | cuda | 0.709 | 807.4 | 48.0 | 0.364 | 40.0 |
| hybrid | cuda | 0.709 | 807.4 | 48.0 | 0.364 | 67.8 |
| prior | cuda | 0.776 | 513.2 | 28.0 | 0.323 | 65.2 |
