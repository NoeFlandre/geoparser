...
| --- | --- | ---: | ---: | ---: |
| upstream | cuda | 0.086 | 0.291 | 0.133 |
| hybrid | cuda | 0.261 | 0.906 | 0.406 |
| prior | cuda | 0.261 | 0.906 | 0.406 |

## Resolution (gold spans supplied, distance scored)

| Pipeline | Device | Acc@161km | Mean err (km) | Median err (km) | AUC | Seconds |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| upstream | cuda | 0.904 | 141.1 | 1.9 | 0.192 | 31.7 |
| hybrid | cuda | 0.904 | 141.1 | 1.9 | 0.192 | 56.5 |
| prior | cuda | 0.909 | 144.0 | 1.7 | 0.189 | 56.6 |
