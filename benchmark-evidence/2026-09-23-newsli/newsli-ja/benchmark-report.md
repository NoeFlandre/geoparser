...
| --- | --- | ---: | ---: | ---: |
| upstream | cuda | 0.000 | 0.000 | 0.000 |
| hybrid | cuda | 0.120 | 0.061 | 0.081 |
| prior | cuda | 0.120 | 0.061 | 0.081 |

## Resolution (gold spans supplied, distance scored)

| Pipeline | Device | Acc@161km | Mean err (km) | Median err (km) | AUC | Seconds |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| upstream | cuda | 0.847 | 248.9 | 2.3 | 0.226 | 22.4 |
| hybrid | cuda | 0.847 | 248.9 | 2.3 | 0.226 | 55.3 |
| prior | cuda | 0.849 | 247.2 | 2.2 | 0.225 | 54.6 |
